...
const pretProducts = [
  { id: '1', name: 'Lawn Printed Kurti', price: 'Rs. 3,499', image: require('../../assets/summerpret1.png') },
  { id: '2', name: 'Chiffon Floral Shirt', price: 'Rs. 4,199', image: require('../../assets/summerpret2.png') },
  { id: '3', name: 'Cotton Embroidered Dress', price: 'Rs. 3,999', image: require('../../assets/summerpret3.png') },
  { id: '4', name: 'Linen Summer Shirt', price: 'Rs. 3,799', image: require('../../assets/summerpret4.png') },
];

const { width } = Dimensions.get('window');
const cardWidth = (width - 48) / 2; // 16px padding + 16px gap

export default function SummerPretScreen() {
  return (
